...
class AddEditEventTaskViewController:
    ...
    var mode: String = "Event"
    
    // bottom tabbar that allow user to choose btw event, task, period
    let flexible = UIBarButtonItem(barButtonSystemItem: .flexibleSpace, target: nil, action: nil)
    let eventBtn = UIButton(type: .custom)
    let taskBtn = UIButton(type: .custom)
    let periodBtn = UIButton(type: .custom)
    ...
    @objc func eventSelected(){
        ...
        // deselect periodBtn
        periodBtn.layer.backgroundColor = UIColor(named: "Default")?.cgColor
        periodBtn.tintColor = UIColor(named: "AccentColor")
        periodBtn.setTitleColor(UIColor(named: "AccentColor"), for: .normal)
        periodBtn.isSelected = false
    }
    ...
    @objc func periodSelected(_ sender: UIButton){
        print("periodSelected")
        // select periodBtn
        periodBtn.layer.backgroundColor = UIColor(named: "AccentColor")?.cgColor
        periodBtn.tintColor = .white
        periodBtn.setTitleColor(.white, for: .normal)
    ...
    func setBackgroundComponents() {
        ...
        // periodBtn
        periodBtn.setImage(UIImage(systemName: "drop.fill"), for: .normal)
        periodBtn.setTitle("Period", for: .normal)
        periodBtn.tintColor = UIColor(named: "AccentColor")
        periodBtn.setTitleColor(UIColor(named: "AccentColor"), for: .normal)
        periodBtn.titleLabel?.font = .boldSystemFont(ofSize: 18)
        periodBtn.frame.size = CGSize(width: 100, height: 25)
        periodBtn.layer.cornerRadius = 10
        periodBtn.addTarget(self, action: #selector(periodSelected), for: .touchUpInside)
        let periodBarBtn = UIBarButtonItem(customView: periodBtn)
        
        
        // add items into bar
        bar.items = [eventBarBtn, flexible, taskBarBtn, flexible, periodBarBtn]
