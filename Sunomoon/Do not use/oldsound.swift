...
//import UIKit
//
//class SoundAlarmViewController: UITableViewController {
//    
...
//        // set the background of tableview to the assign pic
//        self.tableView.backgroundView = UIImageView(image: UIImage(named: "alarmBG"))
